...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_BuyerModal_vue__ = __webpack_require__(19);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__core_Form_js__ = __webpack_require__(3);
//
//
//
//
        ...
        buyerId: function buyerId() {
            ...
            if (this.buyerId) {
                this.form.get('/buyers/' + this.buyerId).then(function (data) {
                    _this2.form.last_name = data.buyer.last_name;
                    _this2.form.first_name = data.buyer.first_name;
                    _this2.form.middle_name = data.buyer.middle_name;
                    _this2.form.extension = data.buyer.extension;
                    _this2.form.contact_number = data.buyer.contact_number;
                    _this2.form.marital_status = data.buyer.marital_status;
                    _this2.form.email = data.buyer.email;
                    _this2.form.work_location = data.buyer.work_location;
                    _this2.form.facebook_url = data.buyer.facebook_url;
                    _this2.form.financing_type = data.buyer.financing_type;
                    _this2.form.country = data.buyer.country;
                    _this2.form.equity_type = data.buyer.equity_type;
                });
            } else {
                this.form.reset();
            }
...
Component.options.__file = "C:\\Users\\Erwin Paolo Yumul\\Projects\\sis\\resources\\assets\\js\\components\\BuyerModal.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
