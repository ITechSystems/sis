...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_PropertyInformation_vue__ = __webpack_require__(20);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_HorizontalFilters_vue__ = __webpack_require__(6);
...
Component.options.__file = "C:\\Users\\Erwin Paolo Yumul\\Projects\\sis\\resources\\assets\\js\\components\\PropertyInformation.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('modal', {
    ...
    return _c('table', {
      ...
      }, [_vm._v("Finance Type")]) : _vm._e(), _vm._v(" "), (index1 == 0) ? _c('th', [_vm._v("Price")]) : _vm._e()])
    }), _vm._v(" "), _vm._l((item.loans), function(loan, index1) {
      return _c('tr', [(index1 == 0) ? _c('td', {
        attrs: {
          "colspan": "3"
        }
      }, [_vm._v(_vm._s(loan.finance_type))]) : _vm._e(), _vm._v(" "), (index1 == 0) ? _c('td', [_vm._v(_vm._s(_vm._f("currency")(item.total_contract_price)))]) : _vm._e()])
    }), _vm._v(" "), _c('tr', [_c('td', [_c('br')]), _vm._v(" "), _c('td', [_c('br')]), _vm._v(" "), _c('td', [_c('br')]), _vm._v(" "), _c('td', [_c('br')]), _vm._v(" "), _c('td', [_c('br')]), _vm._v(" "), _c('td', [_c('br')]), _vm._v(" "), _c('td', [_c('br')])]), _vm._v(" "), _c('tr', [_c('th', [_vm._v("Loan Total")]), _vm._v(" "), _c('th', [_vm._v("MRI")]), _vm._v(" "), _c('th', [_vm._v("Monthly Amortization")]), _vm._v(" "), _c('th', [_vm._v("Loan Percentage")]), _vm._v(" "), _c('th', [_vm._v("Description")]), _vm._v(" "), _c('th', [_vm._v("Monthly Percentage")]), _vm._v(" "), _c('th', [_vm._v("Years")])]), _vm._v(" "), _c('tbody', _vm._l((item.loans), function(loan) {
      return _c('tr', [_c('td', [_vm._v(_vm._s(_vm._f("currency")(loan.total)))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm._f("currency")(loan.mri)))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm._f("currency")(loan.monthly_amortization)))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(loan.percentage))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(loan.description))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm._f("currency")(loan.monthly_percentage)))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(loan.years))])])
    })), _vm._v(" "), _c('tr', [_c('td', {
      attrs: {
        "colspan": "7"
      }
